...
<style scoped>
  .banner-warp{
    min-width: 1200px;
    background: url("../../static/images/banner.jpg") center 0;
    height: 758px;
  }
  .banner{
    width: 1200px;
  ...
  .banner h2{
    ...
    font-size: 60px;
    color: #fff;
    text-shadow: 0px 1px 2px rgba(4, 0, 0, 0.8);
    margin-bottom: 32px;
  }
  .to-Marketplace{
    display: block;
    ...
    color: #fff;
    text-shadow: 0px 1px 2px rgba(4, 0, 0, 0.8);
    box-shadow: 0px 2px 3px rgba(4, 0, 0, 0.8);
  }
  .content-warp{
    min-width: 1200px;
  }
  ...
  dt.show_img{
    background: url("../../static/images/indeximg1.png") center center no-repeat;
  }
  .sho_detail{
    padding-top: 96px;
  }
